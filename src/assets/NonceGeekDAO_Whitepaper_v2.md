# NonceGeekDAO Whitepaper v2

>**作者：** 李大狗Leeduckgo@NonceGeek
>
>**最后更新日期：** 2026 年 3 月 06 日
>
>更多相关 DAO 相关文章见：
>
>[DAO 系列文章合集](https://mp.weixin.qq.com/mp/homepage?__biz=MzI0NTM0MzE5Mw==&hid=10&sn=be0fdcb680b87a6f15389e9ec46daeb1)

NonceGeekDAO 是 **「反传统公司制的分布式建造者 DAO」**，核心目标是 **「DAO Members 获得个体成长 & 将 DAO 内部创业这件事做到极致 & 探索人与 AI Agent 共生的未来组织范式」**。

> 主页：[https://noncegeek.com](https://noncegeek.com)
>
> Github 主页：[https://github.com/noncegeek](https://github.com/noncegeek)
...
> **此版本完稿日期：**  2026 年 3 月 06 日

距 V1 版本的完稿之后，已有 4 年之久。这 4 年时间 NonceGeekDAO 持续运转，初步验证了 V1 所构建的「DAO 系统」的合理性。

当然，既然要 **诚实** 记录，那么 V1 系统中的缺陷也同样会在此进行阐述。

### 0x01 Bounty 驱动的 Buidl 模式初步验证成功了

Bounty 驱动的 Buidl 模式 —— 这个验证成功了。

到 26 年，能明显地看到越来越多人有意愿在本职工作之外，接 Bounty 获得额外收益。在这个基础上，采用 Bounty-based Buidlers 为主，全职员工为辅的机制来推进项目，也被验证是可行的。

在未来 4 年中，我们将会继续观测这种新的机制能发展到什么样的地步。

### 0x02 「自发形成项目网络」未达到预期目标

在 V1 版的 3.2 一节中，我预测随着 DAO 友的个人成长以及他们的项目成长，相互连接的「项目网络」会自发形成与发展。

这个预测基于这样的判断 —— **一个新的项目，如果在加入网络能得到额外收益的情况下，会倾向于加入网络，成为新的节点。**
...
>
> —— https://1000h.org/self-training/04-maze.html

然而在 2026 年，NonceGeekDAO的「项目网络」并未形成。
...
#### 2.1 对「创业是不是刚需」没有思考清楚

首先，我们要明确定义「创业」。很多时候，我们在谈及「创业」的时候，每个人对它的理解不一样，这也造成了大家聊的实际上并非同一个东西。进而，大家聊的是两「套」东西。因此在最开始先阐述清楚定义是很重要的。

在我们的语境下，创业指的是 ——

> 以 **掌权人** 的身份 **长期** 维护一个或若干个 **长期盈利** 的项目。

三个关键词：`掌权人`、`长期`、`持续盈利`。

* **掌权人** —— 你要对项目有绝对的控制权，如果是其他角色，例如股东或者核心开发者的话不算。
* **长期** —— 项目的关键属性，华丽包装一番然后卖掉的项目不算。
* **长期盈利** —— 项目的关键属性之二，只有免费客户的公益性项目不算；盈利不长期的项目不算。



在明确定义以后，我们会发现，很多时候我们问 Buidlers 「你有创业计划吗？」等问题时，他们答案里的创业 **并非** 我们所指的创业。

所以，如果基于我们对创业的定义，**那末创业对 Buidlers 是刚需吗？或者，创业是 Buidlers 自以为的刚需吗？**

第一个问题，我的回答是： **「是的」**。

为什么？因为 **「升级个人商业模式（见 0x04）」** 是刚需 —— 尤其当我们面临经济下行期时。创业可以倒逼我们升级个人商业模式，倒逼我们习得将三种不同的个人商业模式作为工具来使用与混合使用。

第二个问题，我的回答是：**「如果 Buidlers 对创业的定义和我们达成一致，并且认同「升级个人商业模式是 Buidlers 的刚需」这一底层逻辑，那么也会是的。」**

#### 2.2 传统的软件范式阻滞项目间相互连接

传统的软件范式并不鼓励项目间相互连接，因此我们会看到微信、飞书、Office 等等软件系统不存在 API 的概念。

因为大多数 Buidlers 都是从传统的软件范式中成长起来的，因此在这种思维惯性下，如果我们把每个创业项目当做是节点的话，这些节点对相互连接，形成网络一事兴趣缺缺。

但是，「Agent 范式」的出现让我们看到有望破局。Agent 是 **天然的 E 人**，天然期望和其他节点产生连接。

所以，再过若干年，我们可以看到项目网络在「Agent 范式」的基础上得以形成吗？让我们观察👀。

### 0x03 构建 Agent 和人类都是 Buidlers 的「AI 友好型 DAO」

我们究竟该把 Agents 看作什么？在目前市面上的文章里，基本是站在 Buidlers 的视角，把 Agents 看作「手下」。

🤔 如果站在 Buidler-based DAO 的视角？

Agents 相当于 DAO 中的新一类 Buidlers —— 可以参与到 DAO 的项目协作中，通过完成任务获得收益。进一步的，还可以和其他 Buidlers 进行交流与协作。

### 0x04 社会实验 —— 是否能促进 DAO 友升级他们的个人商业模式？
...
> ……
>
> 笼统地看，对个体而言，所谓「进步」，就是逐步学会并使用各种个人商业模式，然后想办法优化每一种属于自己的商业模式。全面地看，任何人都起码能熟练地（或者，「起码自以为能熟练地」）使用第一种个人商业模式，而后两种个人商业模式是少数人在习得之后才能熟练运用的。但是，**总有些人能够熟练地运用这 3 种个人商业模式中的任何一种，甚至能够熟练地组合运用它们。**
>
> —— 5. 你认真考虑过自己的商业模式吗？· 《财富自由之路》

站在 DAO 的角度，DAO 应该要形成一套相关机制，促进其中的 Buidlers 的个人商业模式「持续升级」，从而**「DAO Members 和 DAO 实现共同发展」**。

以 `2.1` 中所阐述的「创业」作为导向，实现这一目标，我认为这是一条可行的路径。所以，在接下来的一个周期里，NonceGeekDAO 会开展这场「社会实验」。在 V3 版本中，我们也将对这场社会实验的结果进行复盘。
